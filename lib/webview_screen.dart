...
// import 'package:MEAMBO/pdf_viewer_screen.dart';
...
//             print(">>> Navigasi Link: ${request.url}");
...
//             // Handle stream dokumen (GET)
//             if (request.url.contains('/list-pengajuan/stream')) {
//               print(">>> Proses Lihat Dokumen");
...
//           print("✅ Login berhasil! User ID: ${message.message}");
...
//           } else {
//             print("⚠️ Invalid user_id: $userId");
//           }
//         },
//       )
...
//         'flutterCetak',
//         onMessageReceived: (JavaScriptMessage message) {
//           print("📄 Request cetak: ${message.message}");
...
//       ..loadRequest(Uri.parse('https://meambo.id/login'));
//   }
...
//       if (formData != null) {
//         print("📦 POST dengan data: $formData");
...
//     print("📤 Registrasi FCM - User: $userId");

//     try {
//       final response = await http.post(
//         Uri.parse('https://meambo.id/api/fcm/save-token'),
//         headers: {
